...
\begin{figure}[H]
  ...
  \caption{Exemplo de uma RNN}
   \includegraphics[width=0.8\textwidth]{figuras/ann_exemplos/rnn_exemplo.png}
...
\begin{itemize}
    ...
    \item \textbf{Sequencia para vetor (sequencie-to-vector)} — Apenas a entrada é uma sequência. É o caso do exemplo discutido acima. 
    Outra aplicação, além da já citada, é análise de sentimentos de uma resenha, onde a rede recebe uma sequência de palavras e deve classificar em:
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.8\textwidth]{figuras/ann_exemplos/lstm_celula.png}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.8\textwidth]{figuras/ann_exemplos/gru_celula.png}
...
formar os olhos, orelhas, até quem, enfim, a rede reconhece o tigre.

\begin{figure}[H]
  \centering
  \caption{Esquema de como uma CNN identificaria um tigre}
  \includegraphics[width=0.8\textwidth]{figuras/ann_exemplos/cnn_tigre.png}
  \label{fig:cnn_tigre}
  \legend{Fonte: Adaptado de \citeonline{james2023}}
\end{figure}
