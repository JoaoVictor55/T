...
diferença percentual entre o \textit{f1-score} de treino e validação para o modelo híbrido foi de aproximadamente 9,56\% 
enquanto que para o modelo recorrente puro, foi de, aproximadamente, 17,98\%.

\begin{table}[H]
\centering
\caption{édia das métricas do modelo híbrido CNN e GRU para a classificação normal vs. ventricular no treino}
...
Por tanto, apesar do desbalanceamento e da variabilidade da classe positiva, os modelos conseguiram 
aprender padrões que lhes permitem classificar as arritmias, entretanto, esses padrões ainda não são 
...
Devido as diferenças metodológicas, a comparação direta entre os resultados não é possível.
