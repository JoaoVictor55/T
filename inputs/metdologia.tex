...
O bloco de CNN precisou ser aplicado em cada batimento dentro da sequência. Trata-se de duas camadas de CNN com 32, com \textit{kernel} de tamanho sete, e 64 filtros, com \textit{kernel} de tamanho cinco, respectivamente.
Todos com \textit{padding} igual. Cada 
...
As redes foram treinadas por 50 épocas.
