...
de ser recomendado pela AAMI \cite{chazal2004,saadatnejad2020}. O banco é parte do recurso PhysioNet \cite{Goldberger2000}.
...
\begin{figure}[H]
  ...
  \legend{Adaptado do \textit{MIT-BIH Arrhythmia Database} \cite{moody2001}, disponível em PhysioNet \cite{Goldberger2000}}
\end{figure}
