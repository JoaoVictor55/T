...
Cada quadrante da matriz representa um tipo de acerto ou erro, a saber:
...
Uma alternativa a curva PR é a curva ROC (\textit{receiver operating characteristic curve}) que exibe a sensibilidade em relação a taxa de falsos positivos. O seu 
