...
O uso de modelos de aprendizado de máquina para auxiliar o diagnóstico de arritmias possui grande potencial, em partes 
devido ao risco que tais arritmias estão associadas e também ao fato de modelos poderem lidar com grande volumes 
de dados e variabilidade. Aplicar tais modelos, entretanto, exige compreender o domínio do problema e como 
ele se relaciona com a área de IA.

No caso do ECG, devido a diversidade de arritmias e a variabilidade natural do sinal, esta aplicação traz 
uma série de desafios. Portanto, a justificativa desse trabalho é compreender como esse processo se dar. 
Espera-se então que as discussões levantas sirva para compreender os desafios e quais possíveis soluções 
podem ser tomadas.
...
alcançados pelos modelos através das métricas empregadas e quais problemas foram identificados. Por fim, no 
capítulo \ref{ch:analise_erros_pior_fold} é feita uma breve investigação do pior caso do melhor modelo.