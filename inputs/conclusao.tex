...
Durante a análise foram identificados outros problemas como superconfiança da rede que é um empecilho para uma adoção em 
...
Para a calibração, \citeonline{mizilPredictingGoodProbs} apontaram métodos como a calibração de Platt, regressão isotônica que são apropriados para a classificação binária.
